...
- (void)updateUI {
    ...
    CGSize __textSize = [RCTextMessageCell getMessageCellSize:_textMessage.content withWidth:self.baseContentView.bounds.size.width];

    if (self.model.content.senderUserInfo) {
        CGSize __nameSize = [RCKitUtility getContentSize:self.model.content.senderUserInfo.name withFrontSize:Text_Message_Font_Size withWidth:self.baseContentView.bounds.size.width];
...
+ (CGSize)getMessageCellSize:(NSString *)content withWidth:(CGFloat)width{
    ...
    textSize = [RCKitUtility getContentSize:content withFrontSize:Text_Message_Font_Size withWidth:maxWidth];
