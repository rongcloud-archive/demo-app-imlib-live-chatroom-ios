...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RCMessageContent *messageContent = model.content;
    if ([messageContent isMemberOfClass:[RCTextMessage class]] || [messageContent isMemberOfClass:[RCInformationNotificationMessage class]] || [messageContent isMemberOfClass:[RCGiftMessage class]]) {
...
- (CGSize)sizeForItem:(UICollectionView *)collectionView
    ...
    if ([messageContent
        ...
        CGSize __labelSize = [RCTipMessageCell getTipMessageCellSize:localizedMessage];
        ...
        CGSize _textMessageSize = [RCTextMessageCell getMessageCellSize:_textMessage.content withWidth:__width];
...
- (void)appendAndDisplayMessage:(RCMessage *)rcMessage {
    ...
    if([rcMessage.content isMemberOfClass:[RCGiftMessage class]]){
        model.messageId = -1;
    }
                           ...
                           success:^(long messageId) {
                               ...
                               dispatch_async(dispatch_get_main_queue(), ^{
                                   RCMessage *message = [[RCMessage alloc] initWithType:__weakself.conversationType
                                                                              ...
                                                                              messageId:messageId
                                                                                content:messageContent];
                                   if ([message.content isMemberOfClass:[RCGiftMessage class]] ) {
